...
class AuthRemoteDataSource {
  ...
  Future<Map<String, dynamic>> socialSignInUser({required auth.AuthProvider authProvider, required BuildContext context, String? email, String? password, String? otp, String? verifiedId}) async {
    Map<String, dynamic> result = {};

    try {
      switch (authProvider) {
        case auth.AuthProvider.gmail:
