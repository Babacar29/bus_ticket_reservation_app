...
class GettingStartedScreenState extends State<IntroSliderScreen> with TickerProviderStateMixin {
  ...
  late List<Slide> slideList = [
    Slide(imageUrl: UiUtils.getImagePath('idi.jpeg'), title: UiUtils.getTranslatedLabel(context, 'welTitle1'), description: UiUtils.getTranslatedLabel(context, 'welDes1'), ),
    Slide(imageUrl: UiUtils.getImagePath('idi_2.jpeg'), title: UiUtils.getTranslatedLabel(context, 'welTitle2'), description: UiUtils.getTranslatedLabel(context, 'welDes2')),
    ...
    return PreferredSize(
      ...
      child: Padding(
        ...
        child: Row(
            ...
            children: [SizedBox(height: 48, child: Image.asset(UiUtils.getImagePath("reewmi_logo.png"), fit: BoxFit.fill)), setSkipButton()]),
      ),
    );
  }
