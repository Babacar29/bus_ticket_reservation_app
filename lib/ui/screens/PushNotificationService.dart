...
class PushNotificationService {
  ...
  Future<void> _startForegroundService() async {
    const AndroidNotificationDetails androidNotificationDetails =
        AndroidNotificationDetails('com.reewmi.wrteam', 'news', channelDescription: 'your channel description', importance: Importance.max, priority: Priority.high, ticker: 'ticker');
...
Future<void> generateSimpleNotification(String title, String msg, String type) async {
  var androidPlatformChannelSpecifics = const AndroidNotificationDetails(
      'com.reewmi.wrteam', //your package name
      'news',
